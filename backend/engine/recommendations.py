...
def enrich_recommendations_with_llm(
    ...
    Wraps the Groq LLM client. Returns enriched recommendations or None on failure.
    """
    from backend.engine.llm import generate_enriched_recommendations

    return generate_enriched_recommendations(
        audit_id=audit_id,
